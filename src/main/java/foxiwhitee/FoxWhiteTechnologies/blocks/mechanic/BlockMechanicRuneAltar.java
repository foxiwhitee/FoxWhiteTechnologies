...
import foxiwhitee.FoxWhiteTechnologies.client.gui.mechanic.GuiMechanicRuneAltar;
...
@SimpleGuiHandler(tile = TileMechanicRuneAltar.class, gui = GuiMechanicRuneAltar.class, container = ContainerMechanicRuneAltar.class)
public class BlockMechanicRuneAltar extends FoxBaseBlock {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        if (tile instanceof TileMechanicRuneAltar)
            FMLNetworkHandler.openGui(player, FoxLib.instance, GuiHandlers.getHandler(BlockMechanicRuneAltar.class), world, x, y, z);
        return true;
    }
    ...
    public int getRenderType() {
        return RenderIDs.MECHANIC_RUNE_ALTAR.getId();
    }
}
