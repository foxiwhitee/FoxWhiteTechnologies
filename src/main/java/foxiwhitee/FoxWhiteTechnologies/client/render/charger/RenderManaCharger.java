...
import foxiwhitee.FoxWhiteTechnologies.client.model.ModelCharger;
...
public class RenderManaCharger extends TileEntitySpecialRenderer {
    ...
    public static ResourceLocation TEXTURE_CHARGER = new ResourceLocation(FoxWTCore.MODID.toLowerCase() + ":textures/blocks/manaCharger.png");
