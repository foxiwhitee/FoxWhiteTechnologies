...
import foxiwhitee.FoxWhiteTechnologies.client.model.CustomModelPool;
...
public class RenderCustomManaPool1 extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler {
    private ResourceLocation texture;
    private static final CustomModelPool model = new CustomModelPool();
    ...
    public RenderCustomManaPool1(TileEntity clazz, int renderID) {
        this.clazz = clazz;
    ...
    public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
        ...
        texture = new ResourceLocation(FoxWTCore.MODID.toLowerCase(), "textures/blocks/" + pool.getName() + ".png");GL11.glPushMatrix();
        GL11.glEnable(3042);
