...
public class ItemStorageUpgrade extends DefaultItem {
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List<String> p_77624_3_, boolean p_77624_4_) {
        if (WTConfig.enable_tooltips) {
            p_77624_3_.add(StatCollector.translateToLocalFormatted("tooltip.storageUpgrade.description", switch (p_77624_1_.getItemDamage()) {
